...
Origin.prototype.createServer = function (options, cb) {
  ...
  if (options.minimal) {
	...
	// TJM - 07/07/16 - commented out because of this error:
	/*
	info: [07 Jul 2016 19:28:02 +00:00] Run "node upgrade.js" to update to the latest version
/adapt_authoring/node_modules/express/lib/application.js:209
    throw new TypeError('app.use() requires middleware functions');
    ^

TypeError: app.use() requires middleware functions
    at EventEmitter.use (/adapt_authoring/node_modules/express/lib/application.js:209:11)
    at Origin.createServer (/adapt_authoring/lib/application.js:261:12)
    at /adapt_authoring/lib/application.js:470:11
...
All routing methods will be added in the order in which they appear
	*/
	// trying without this to see if it will build right
